...
function TaskDefinition({previousStep, nextStep, changeData, initialState}) {
  ...
  return (
    <div>
        ...
        <p>Para continuar a pesquisa, preciso que você pense numa experiência recente que você tenha considerado <b>DESMOTIVANTE</b> durante o uso de um jogo digital.</p>
        <p>Pensou? Agora pense numa tarefa que, durante o uso desse jogo, te fez considerar a experiência desta forma.</p>
        <p>Calma que posso te dar um exemplo! Vamos supor que uma pessoa não goste da franquia Mario ou não gosta de perder muito tempo jogando. Neste cenário, um exemplo de tarefa que pode ser considerada desmotivante para essa pessoa é: "Terminar a primeira fase do jogo Super Mario World sem ser atacado por nenhum inimigo".</p>
        <br />
        <FormGroup>
            <Label for="jogo">
        ...
        <p><b>Eu não gosto de ________________</b></p>
        <p><b>Eu me sinto entediado ao _______________</b></p>
